### 1.4.1 (Next)
* [#98](https://github.com/dblock/iex-ruby-client/pull/98): Update READme.md for histroical daily request date parsing issue - [@umer_frooq](https://github.com/UmerFrooq).
